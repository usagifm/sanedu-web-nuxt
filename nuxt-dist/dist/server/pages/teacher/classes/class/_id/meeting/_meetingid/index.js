...
module.exports.__inject__ = function (context) {
  add("68e0923a", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_nuxt_webpack_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_2aaa08bb_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(382);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_nuxt_webpack_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_2aaa08bb_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_nuxt_webpack_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_2aaa08bb_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_nuxt_webpack_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_2aaa08bb_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_nuxt_webpack_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_2aaa08bb_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".videoWrapper[data-v-2aaa08bb]{position:relative;padding-bottom:56.25%;padding-top:25px;height:0}.videoWrapper iframe[data-v-2aaa08bb]{position:absolute;top:0;left:0;width:100%;height:100%}", ""]);
// Exports
module.exports = exports;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/teacher/classes/class/_id/meeting/_meetingid/index.vue?vue&type=template&id=2aaa08bb&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-layout',[_c('v-container',[(_vm.isLoaded == false)?_c('v-container',{attrs:{"fluid":""}},[_c('v-row',{attrs:{"jalign":"center","justify":"center"}},[_c('v-col',{attrs:{"cols":"6"}},[_c('v-progress-linear',{attrs:{"rounded":"","height":"6","indeterminate":"","color":"blue lighten-1"}})],1)],1)],1):_vm._e(),_vm._v(" "),(_vm.isLoaded == true)?_c('v-flex',[_c('v-alert',{staticStyle:{"text-decoration":"none","font-weight":"bold"},attrs:{"border":"top","colored-border":"","type":"info","elevation":"2"}},[_c('v-fab-transition',[_c('nuxt-link',{staticStyle:{"text-decoration":"none"},attrs:{"to":{
              ...
              params: { id: _vm.classDetail.id },
            }}},[_c('v-btn',{attrs:{"color":"blue darken-1","fab":"","dark":"","medium":"","fixed":"","bottom":"","left":""}},[_c('v-icon',[_vm._v("mdi-arrow-left")])],1)],1)],1),_vm._v(" "),_c('v-breadcrumbs',{staticClass:"pb-1 pt-3",attrs:{"link":"","items":_vm.breadcrumbs,"divider":"/"}})],1),_vm._v(" "),_c('v-row',{attrs:{"justify":"center","align":"center"}},[_c('v-col',{attrs:{"align":"left","cols":"12"}},[_c('v-card',{attrs:{"color":"teal","dark":""}},[_c('v-app-bar',{attrs:{"flat":"","color":"rgba(0, 0, 0, 0)"}},[_c('v-icon',{attrs:{"color":"white"}},[_vm._v("mdi-calendar")]),_vm._v(" "),_c('v-card-title',{staticClass:"text-left",staticStyle:{"font-weight":"bolder"}},[_vm._v(" Meeting ")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-menu',{attrs:{"offset-y":"","transition":"slide-y-transition","bottom":""},scopedSlots:_vm._u([{key:"activator",fn:function(ref){
            var on = ref.on;
            var attrs = ref.attrs;
return [_c('v-btn',_vm._g(_vm._b({attrs:{"color":"white","icon":""}},'v-btn',attrs,false),on),[_c('v-icon',[_vm._v("mdi-dots-vertical")])],1)]}}],null,false,3444389850)},[_vm._v(" "),_c('v-list',[_c('v-list-item',{attrs:{"link":""},on:{"click":function($event){_vm.editMeetingDialog = true}}},[_c('v-list-item-title',{staticStyle:{"font-weight":"bold"}},[_c('v-icon',[_vm._v("mdi-pencil")]),_vm._v(" Edit\n                      Meeting")],1)],1),_vm._v(" "),_c('v-list-item',{attrs:{"link":""},on:{"click":function($event){_vm.deleteMeetingDialog = true}}},[_c('v-list-item-title',{staticStyle:{"font-weight":"bold"}},[_c('v-icon',[_vm._v("mdi-delete")]),_vm._v(" Delete\n                      Meeting")],1)],1)],1)],1)],1),_vm._v(" "),_c('v-card-title',{staticClass:"headline",staticStyle:{"font-weight":"bold"}},[_vm._v("\n              "+_vm._s(_vm.meetingDetail.name)+"\n            ")]),_vm._v(" "),_c('v-card-subtitle',{staticStyle:{"font-weight":"bold"}},[_vm._v(_vm._s(_vm.classDetail.teacher_name))]),_vm._v(" "),_c('v-col',[_c('v-chip',{staticClass:"my-2",staticStyle:{"font-weight":"bold"},attrs:{"color":"teal darken-3","text-color":"white"}},[_c('v-avatar',{attrs:{"left":""}},[_c('v-icon',[_vm._v("mdi-calendar")])],1),_vm._v(_vm._s(_vm.meetingDetail.date)+"\n              ")],1),_vm._v(" "),_c('v-chip',{staticClass:"my-2",staticStyle:{"font-weight":"bold"},attrs:{"color":"teal darken-2","text-color":"white"}},[_vm._v(_vm._s(_vm.meetingDetail.start_time)+" -\n                "+_vm._s(_vm.meetingDetail.finish_time))])],1),_vm._v(" "),_c('v-card-actions',[_c('v-tooltip',{attrs:{"bottom":""},scopedSlots:_vm._u([{key:"activator",fn:function(ref){
            var on = ref.on;
            var attrs = ref.attrs;
return [(_vm.meetingDetail.quiz)?_c('nuxt-link',{staticStyle:{"text-decoration":"none"},attrs:{"to":{
                    ...
                    }}},[_c('v-btn',_vm._g(_vm._b({staticClass:"ml-2 mb-2 my-4",attrs:{"rounded":"","color":"primary","dark":""}},'v-btn',attrs,false),on),[_c('v-icon',{attrs:{"left":""}},[_vm._v("mdi-pencil")]),_vm._v("\n\n                      Edit Quiz\n                    ")],1)],1):_vm._e()]}}],null,false,718247739)},[_vm._v(" "),_c('span',[_vm._v("Click to edit quiz")])]),_vm._v(" "),_c('v-tooltip',{attrs:{"bottom":""},scopedSlots:_vm._u([{key:"activator",fn:function(ref){
                    var on = ref.on;
                    var attrs = ref.attrs;
return [(_vm.meetingDetail.quiz == null)?_c('v-btn',_vm._g(_vm._b({staticClass:"ml-4 mb-2 my-4",attrs:{"rounded":"","color":"blue lighten-2","dark":""},on:{"click":function($event){_vm.createQuizDialog = true}}},'v-btn',attrs,false),on),[_c('v-icon',{attrs:{"left":""}},[_vm._v("mdi-pencil")]),_vm._v("\n\n                      Create Quiz\n                    ")],1):_vm._e()]}}],null,false,2960842879)},[_vm._v(" "),_c('span',[_vm._v("See Quiz Result")])])],1),_vm._v(" "),_c('v-card-actions',[_c('v-spacer'),_vm._v(" "),_c('v-btn',{staticClass:"mr-4 mb-2 my-4",staticStyle:{"font-weight":"bold"},attrs:{"rounded":"","color":"green","dark":""},on:{"click":function($event){_vm.createLessonDialog = true}}},[_c('v-icon',{attrs:{"left":""}},[_vm._v("mdi-plus")]),_vm._v("\n\n                Create Lesson\n              ")],1)],1)],1)],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"cols":"12"}},[_c('v-card',{attrs:{"outlined":""}},[_c('v-tabs',{attrs:{"text":""}},[_c('v-tabs-slider'),_vm._v(" "),_c('v-tab',{staticStyle:{"text-decoration":"none"},attrs:{"href":"#tab-1"},on:{"click":_vm.lessons}},[_vm._v("\n                Lessons\n              ")]),_vm._v(" "),_c('v-tab',{staticStyle:{"text-decoration":"none"},attrs:{"href":"#tab-2"},on:{"click":_vm.attendances}},[_vm._v("\n                Attendances\n              ")]),_vm._v(" "),_c('v-tab',{staticStyle:{"text-decoration":"none"},attrs:{"href":"#tab-3"},on:{"click":_vm.attemps}},[_vm._v("\n                Attemps\n              ")])],1)],1)],1)],1),_vm._v(" "),_c('v-row',[_vm._l((_vm.meetingDetail.lessons),function(item){return _c('v-col',{directives:[{name:"show",rawName:"v-show",value:(_vm.showLessons),expression:"showLessons"}],key:item.id,attrs:{"align":"left","cols":"12","lg":"12","md":"12","xs":"12","sm":"12"}},[_c('v-hover',{scopedSlots:_vm._u([{key:"default",fn:function(ref){
                    var hover = ref.hover;
return [_c('v-card',{class:{ 'on-hover': hover },attrs:{"color":"white","light":"","elevation":hover ? 4 : 2}},[_c('v-app-bar',{staticClass:"pb-0 mb-n5",attrs:{"flat":"","color":"rgba(0, 0, 0, 0)"}},[_c('v-icon',{attrs:{"color":"primary"}},[_vm._v("mdi-book-open-variant")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-menu',{attrs:{"offset-y":"","transition":"slide-y-transition","bottom":""},scopedSlots:_vm._u([{key:"activator",fn:function(ref){
                    var on = ref.on;
                    var attrs = ref.attrs;
return [_c('v-btn',_vm._g(_vm._b({attrs:{"color":"primary","icon":""}},'v-btn',attrs,false),on),[_c('v-icon',[_vm._v("mdi-dots-vertical")])],1)]}}],null,true)},[_vm._v(" "),_c('v-list',[_c('v-list-item',{attrs:{"link":""},on:{"click":function($event){return _vm.openEditLessonDialog(item)}}},[_c('v-list-item-title',{staticStyle:{"font-weight":"bold"}},[_c('v-icon',[_vm._v("mdi-pencil")]),_vm._v(" Edit\n                        Lesson")],1)],1),_vm._v(" "),_c('v-list-item',{attrs:{"link":""},on:{"click":function($event){return _vm.openDeleteLessonDialog(item)}}},[_c('v-list-item-title',{staticStyle:{"font-weight":"bold"}},[_c('v-icon',[_vm._v("mdi-delete")]),_vm._v("Delete\n                        Lesson")],1)],1)],1)],1)],1),_vm._v(" "),_c('v-card-title',{staticClass:"headline"},[_vm._v("\n                "+_vm._s(item.name)+"\n                ")]),_vm._v(" "),_c('v-card-subtitle',[_vm._v("Click For Detail")]),_vm._v(" "),_c('v-card-actions',[(item.youtube !== null)?_c('div',[_c('v-btn',{attrs:{"small":"","rounded":"","color":"red","dark":"","text":""}},[_c('v-icon',{attrs:{"left":""}},[_vm._v("mdi-youtube")]),_vm._v("With Video\n                  ")],1)],1):_vm._e(),_vm._v(" "),(item.link !== null)?_c('div',[_c('v-btn',{attrs:{"small":"","rounded":"","color":"primary","dark":"","text":""}},[_c('v-icon',{attrs:{"left":""}},[_vm._v("mdi-link")]),_vm._v("With Link\n                  ")],1)],1):_vm._e()])],1)]}}],null,true)})],1)}),_vm._v(" "),(_vm.showAttendances == true && _vm.meetingDetail.attendees != '')?_c('v-col',{attrs:{"cols":"12"}},[_c('v-row',[_c('v-col',[_c('v-card',{staticClass:"py-3 pb-0",attrs:{"light":""}},[_c('v-card-title',{staticClass:"headline"},[_vm._v("Student Attendances")]),_vm._v(" "),_c('v-simple-table',{attrs:{"fixed-header":""},scopedSlots:_vm._u([{key:"default",fn:function(){return [_c('thead',[_c('tr',[_c('th',{staticClass:"text-left"},[_vm._v("\n                                    Name\n                                ")]),_vm._v(" "),_vm._l((_vm.meetingDetail.attendees[0].attendance),function(header){return _c('th',{key:header.type,staticClass:"text-center"},[(header.lesson != null)?_c('span',[_vm._v(_vm._s(header.lesson))]):_vm._e(),_vm._v(" "),(header.quiz != null)?_c('span',[_vm._v(_vm._s(header.quiz))]):_vm._e()])})],2)]),_vm._v(" "),_c('tbody',_vm._l((_vm.meetingDetail.attendees),function(attendees){return _c('tr',{key:attendees.id},[_c('td',{staticClass:"text-left"},[_vm._v(_vm._s(attendees.name))]),_vm._v(" "),_vm._l((attendees.attendance),function(attendancesData){return _c('td',{key:attendancesData.lesson,staticClass:"text-center"},[(attendancesData.is_present == false)?_c('span',[_c('v-btn',{staticStyle:{"color":"white","font-weight":"bold"},attrs:{"x-small":"","rounded":"","depressed":"","color":"red darken-1"}},[_vm._v("\n                                        Absent\n                                        ")])],1):_vm._e(),_vm._v(" "),(attendancesData.is_present == true)?_c('span',[_c('v-btn',{staticStyle:{"color":"white","font-weight":"bold"},attrs:{"x-small":"","rounded":"","depressed":"","color":"green darken-1"}},[_vm._v("\n                                        Present\n                                          ")])],1):_vm._e()])})],2)}),0)]},proxy:true}],null,false,869842786)})],1)],1)],1)],1):_vm._e(),_vm._v(" "),(_vm.showAttemps == true && _vm.meetingDetail.quiz_attempts != '')?_c('v-col',{attrs:{"cols":"12"}},[_c('v-row',[_c('v-col',[_c('v-card',{staticClass:"py-3 pb-0",attrs:{"light":""}},[_c('v-card-title',{staticClass:"headline"},[_vm._v("Quiz Attempts")]),_vm._v(" "),_c('v-card-subtitle',{staticClass:"text-left",staticStyle:{"font-weight":"bold"}},[_vm._v(_vm._s(_vm.meetingDetail.quiz.name))]),_vm._v(" "),_vm._l((_vm.meetingDetail.quiz_attempts),function(attempt){return _c('div',{key:attempt.id},[_c('nuxt-link',{staticStyle:{"text-decoration":"none"},attrs:{"to":{
                        name: 'teacher-classes-class-id-meeting-meetingid-quiz-quizid-attempt-attemptid',
                        params: { id: _vm.classDetail.id, meetingid: _vm.meetingDetail.id , quizid: _vm.meetingDetail.quiz.id, attemptid: attempt.id},
                      }}},[_c('v-list-item',{attrs:{"link":""}},[_c('v-list-item-avatar',[_c('img',{attrs:{"src":"https://res.cloudinary.com/douzspxoy/image/upload/v1626922054/images/profile/profile_tlwd3z.png"}})]),_vm._v(" "),_c('v-list-item-content',[_c('v-list-item-title',{staticClass:"text-left"},[_vm._v(_vm._s(attempt.student_name))]),_vm._v(" "),_c('v-list-item-subtitle',{staticClass:"text-left"},[_vm._v(_vm._s(attempt.student_school))]),_vm._v(" "),_c('v-list-item-subtitle',{staticClass:"my-2 text-left"},[_c('v-btn',{staticStyle:{"color":"white","font-weight":"bold"},attrs:{"depressed":"","rounded":"","color":"green","x-small":""}},[_vm._v("\n                                    Correct : "+_vm._s(attempt.correct_number)+"\n                                        \n                                    ")]),_vm._v(" "),_c('v-btn',{staticStyle:{"color":"white","font-weight":"bold"},attrs:{"depressed":"","rounded":"","color":"red darken-1","x-small":""}},[_vm._v("\n                                    Incorrect : "+_vm._s(attempt.incorrect_number)+"\n\n                                        \n                                    ")]),_vm._v(" "),_c('v-btn',{staticStyle:{"color":"white","font-weight":"bold"},attrs:{"depressed":"","rounded":"","color":"grey darken-1","x-small":""}},[_vm._v("\n                                    Not Answered : "+_vm._s(attempt.not_answered_number)+"\n                                    \n                                        \n                                    ")])],1)],1),_vm._v(" "),_c('v-list-item-action',[_c('v-btn',{staticStyle:{"background-color":"#1976D2","font-weight":"bolder"},attrs:{"icon":"","x-large":"","dark":""}},[_vm._v("\n                              "+_vm._s(attempt.score)+"\n                            ")])],1)],1),_vm._v(" "),_c('v-divider')],1)],1)})],2)],1)],1)],1):_vm._e()],2)],1):_vm._e(),_vm._v(" "),_c('div',{staticClass:"text-center"},[_c('v-snackbar',{attrs:{"timeout":"2000"},scopedSlots:_vm._u([{key:"action",fn:function(ref){
                      var attrs = ref.attrs;
return [_c('v-btn',_vm._b({attrs:{"color":"blue","text":""},on:{"click":function($event){_vm.snackbar = false}}},'v-btn',attrs,false),[_vm._v("\n            Close\n          ")])]}}]),model:{value:(_vm.snackbar),callback:function ($$v) {_vm.snackbar=$$v},expression:"snackbar"}},[_vm._v("\n        "+_vm._s(_vm.text)+"\n\n        ")])],1),_vm._v(" "),_c('v-dialog',{attrs:{"persistent":"","max-width":"500"},model:{value:(_vm.editMeetingDialog),callback:function ($$v) {_vm.editMeetingDialog=$$v},expression:"editMeetingDialog"}},[_c('v-card',[_c('v-toolbar',{attrs:{"color":"primary","dark":""}},[_c('v-card-title',{staticClass:"headline",staticStyle:{"font-weight":"bold"}},[_vm._v("\n            Edit Meeting\n          ")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"white","icon":""},on:{"click":_vm.closeDialog}},[_c('v-icon',[_vm._v("mdi-close-thick")])],1)],1),_vm._v(" "),(_vm.isLoading == true)?_c('v-progress-linear',{attrs:{"indeterminate":"","color":"cyan"}}):_vm._e(),_vm._v(" "),_c('validation-observer',{ref:"observer",scopedSlots:_vm._u([{key:"default",fn:function(ref){
                      var invalid = ref.invalid;
return [_c('form',{on:{"submit":function($event){$event.preventDefault();return _vm.editClassMeeting($event)}}},[_c('v-card-text',[_c('v-col',{attrs:{"cols":"12"}},[_c('validation-provider',{attrs:{"name":"Meeting Name","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
...
return [_c('v-text-field',_vm._g(_vm._b({attrs:{"error-messages":errors,"label":"Finish Time","prepend-icon":"mdi-clock-time-four-outline","dense":"","outlined":"","readonly":""},model:{value:(_vm.meetingPayload.finish_time),callback:function ($$v) {_vm.$set(_vm.meetingPayload, "finish_time", $$v)},expression:"meetingPayload.finish_time"}},'v-text-field',attrs,false),on))]}}],null,true),model:{value:(_vm.finishMenu),callback:function ($$v) {_vm.finishMenu=$$v},expression:"finishMenu"}},[_vm._v(" "),(_vm.finishMenu)?_c('v-time-picker',{attrs:{"format":"24hr","min":_vm.meetingPayload.start_time,"full-width":""},on:{"click:minute":function($event){return _vm.$refs.menu2.save(_vm.meetingPayload.finish_time)}},model:{value:(_vm.meetingPayload.finish_time),callback:function ($$v) {_vm.$set(_vm.meetingPayload, "finish_time", $$v)},expression:"meetingPayload.finish_time"}}):_vm._e()],1)]}}],null,true)})],1)],1)],1)],1),_vm._v(" "),_c('v-card-actions',{staticClass:"py-4 pb-4",staticStyle:{"background-color":"#e0e0e0"}},[_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"red darken-1","text":""},on:{"click":_vm.closeDialog}},[_vm._v("\n                CANCEL\n              ")]),_vm._v(" "),(
                  _vm.meetingPayload.date != null &&
                  _vm.meetingPayload.start_time != null &&
                  _vm.meetingPayload.finish_time != null
                )?_c('v-btn',{staticClass:"py-4 pb-4",attrs:{"disabled":invalid,"color":"primary"},on:{"click":_vm.editClassMeeting}},[_vm._v("\n                Edit\n              ")]):_vm._e(),_vm._v(" "),(
                  _vm.meetingPayload.date == null ||
                  _vm.meetingPayload.start_time == null ||
                  _vm.meetingPayload.finish_time == null
                )?_c('v-btn',{staticClass:"py-4 pb-4",attrs:{"disabled":"","color":"primary"}},[_vm._v("\n                Edit\n              ")]):_vm._e()],1)],1)]}}])})],1)],1),_vm._v(" "),_c('v-dialog',{attrs:{"persistent":"","max-width":"450"},model:{value:(_vm.deleteMeetingDialog),callback:function ($$v) {_vm.deleteMeetingDialog=$$v},expression:"deleteMeetingDialog"}},[_c('v-card',[_c('v-card-title',{staticClass:"headline"},[_vm._v(" Delete Meeting ")]),_vm._v(" "),_c('v-card-text',[_vm._v("Apakah anda yakin ingin menghapus meeting\n          "),_c('code',[_vm._v(_vm._s(_vm.meetingDetail.name))]),_vm._v(" dari kelas\n          "),_c('code',[_vm._v(_vm._s(_vm.classDetail.name))]),_vm._v(" ?")]),_vm._v(" "),_c('v-card-actions',[_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"grey darken-1","text":""},on:{"click":_vm.closeDialog}},[_vm._v("\n            Batal\n          ")]),_vm._v(" "),_c('v-btn',{attrs:{"color":"red darken-1","text":""},on:{"click":_vm.deleteMeeting}},[_vm._v("\n            Delete\n          ")])],1)],1)],1),_vm._v(" "),_c('v-dialog',{attrs:{"persistent":"","max-width":"500"},model:{value:(_vm.createLessonDialog),callback:function ($$v) {_vm.createLessonDialog=$$v},expression:"createLessonDialog"}},[_c('v-card',[_c('v-toolbar',{attrs:{"color":"primary","dark":""}},[_c('v-card-title',{staticClass:"headline",staticStyle:{"font-weight":"bold"}},[_vm._v("\n            Create Lesson\n          ")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"white","icon":""},on:{"click":_vm.closeDialog}},[_c('v-icon',[_vm._v("mdi-close-thick")])],1)],1),_vm._v(" "),(_vm.isLoading == true)?_c('v-progress-linear',{attrs:{"indeterminate":"","color":"cyan"}}):_vm._e(),_vm._v(" "),_c('validation-observer',{ref:"observer",scopedSlots:_vm._u([{key:"default",fn:function(ref){
                var invalid = ref.invalid;
return [_c('form',{on:{"submit":function($event){$event.preventDefault();return _vm.createMeetingLesson($event)}}},[_c('v-card-text',[_c('v-col',{attrs:{"cols":"12"}},[_c('validation-provider',{attrs:{"name":"Meeting Name","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                var errors = ref.errors;
return [_c('v-text-field',{attrs:{"counter":35,"error-messages":errors,"label":"Lesson Name","required":"","outlined":"","dense":""},model:{value:(_vm.lessonPayload.name),callback:function ($$v) {_vm.$set(_vm.lessonPayload, "name", $$v)},expression:"lessonPayload.name"}})]}}],null,true)})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12"}},[_c('v-text-field',{attrs:{"label":"Lesson Link","outlined":"","dense":"","placeholder":"Ex : https://meet.google.com/zhe-etpo-jii"},model:{value:(_vm.lessonPayload.link),callback:function ($$v) {_vm.$set(_vm.lessonPayload, "link", $$v)},expression:"lessonPayload.link"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12"}},[_c('v-text-field',{attrs:{"label":"Youtube Link","outlined":"","dense":"","placeholder":"Ex : https://www.youtube.com/watch?v=mBhqJam52rs"},on:{"change":function($event){return _vm.setYoutube(_vm.lessonPayload.youtube)}},model:{value:(_vm.lessonPayload.youtube),callback:function ($$v) {_vm.$set(_vm.lessonPayload, "youtube", $$v)},expression:"lessonPayload.youtube"}})],1),_vm._v(" "),_c('div',{staticClass:"videoWrapper"},[_c('iframe',{staticClass:"py-2 px-2",attrs:{"width":"300","height":"180","src":_vm.ytvid,"frameborder":"0","allow":"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"}})])],1),_vm._v(" "),_c('v-card-actions',{staticClass:"py-4 pb-4",staticStyle:{"background-color":"#e0e0e0"}},[_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"red darken-1","text":""},on:{"click":_vm.closeDialog}},[_vm._v("\n                CANCEL\n              ")]),_vm._v(" "),_c('v-btn',{staticClass:"py-4 pb-4",attrs:{"disabled":invalid,"color":"primary"},on:{"click":_vm.createMeetingLesson}},[_vm._v("\n                Create\n              ")])],1)],1)]}}])})],1)],1),_vm._v(" "),_c('v-dialog',{attrs:{"persistent":"","max-width":"500"},model:{value:(_vm.editLessonDialog),callback:function ($$v) {_vm.editLessonDialog=$$v},expression:"editLessonDialog"}},[_c('v-card',[_c('v-toolbar',{attrs:{"color":"primary","dark":""}},[_c('v-card-subtitle',{staticStyle:{"font-weight":"bold","color":"white"}},[_vm._v("\n            Edit Lesson "+_vm._s(_vm.selectedLesson.oldName)+"\n          ")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"white","icon":""},on:{"click":_vm.closeDialog}},[_c('v-icon',[_vm._v("mdi-close-thick")])],1)],1),_vm._v(" "),(_vm.isLoading == true)?_c('v-progress-linear',{attrs:{"indeterminate":"","color":"cyan"}}):_vm._e(),_vm._v(" "),_c('validation-observer',{ref:"observer",scopedSlots:_vm._u([{key:"default",fn:function(ref){
                var invalid = ref.invalid;
return [_c('form',{on:{"submit":function($event){$event.preventDefault();return _vm.editMeetingLesson($event)}}},[_c('v-card-text',[_c('v-col',{attrs:{"cols":"12"}},[_c('validation-provider',{attrs:{"name":"Meeting Name","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                var errors = ref.errors;
return [_c('v-text-field',{attrs:{"counter":35,"error-messages":errors,"label":"Lesson Name","required":"","outlined":"","dense":""},model:{value:(_vm.selectedLesson.name),callback:function ($$v) {_vm.$set(_vm.selectedLesson, "name", $$v)},expression:"selectedLesson.name"}})]}}],null,true)})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12"}},[_c('v-text-field',{attrs:{"label":"Lesson Link","outlined":"","dense":"","placeholder":"Ex : https://meet.google.com/zhe-etpo-jii"},model:{value:(_vm.selectedLesson.link),callback:function ($$v) {_vm.$set(_vm.selectedLesson, "link", $$v)},expression:"selectedLesson.link"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12"}},[_c('v-text-field',{attrs:{"label":"Youtube Link","outlined":"","dense":"","placeholder":"Ex : https://www.youtube.com/watch?v=mBhqJam52rs"},on:{"change":function($event){return _vm.setYoutube(_vm.selectedLesson.youtube)}},model:{value:(_vm.selectedLesson.youtube),callback:function ($$v) {_vm.$set(_vm.selectedLesson, "youtube", $$v)},expression:"selectedLesson.youtube"}})],1),_vm._v(" "),_c('div',{staticClass:"videoWrapper"},[_c('iframe',{staticClass:"py-2 px-2",attrs:{"width":"400","height":"300","src":_vm.ytvid,"frameborder":"0","allow":"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"}})])],1),_vm._v(" "),_c('v-card-actions',{staticClass:"py-4 pb-4",staticStyle:{"background-color":"#e0e0e0"}},[_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"red darken-1","text":""},on:{"click":_vm.closeDialog}},[_vm._v("\n                CANCEL\n              ")]),_vm._v(" "),_c('v-btn',{staticClass:"py-4 pb-4",attrs:{"disabled":invalid,"color":"primary"},on:{"click":_vm.editMeetingLesson}},[_vm._v("\n                Edit\n              ")])],1)],1)]}}])})],1)],1),_vm._v(" "),_c('v-dialog',{attrs:{"persistent":"","max-width":"450"},model:{value:(_vm.deleteLessonDialog),callback:function ($$v) {_vm.deleteLessonDialog=$$v},expression:"deleteLessonDialog"}},[_c('v-card',[_c('v-card-title',{staticClass:"headline"},[_vm._v(" Delete Lesson ")]),_vm._v(" "),_c('v-card-text',[_vm._v("Apakah anda yakin ingin menghapus materi\n          "),_c('code',[_vm._v(" "+_vm._s(_vm.selectedLesson ? _vm.selectedLesson.name : ""))]),_vm._v(" dari\n          pertemuan "),_c('code',[_vm._v(" "+_vm._s(_vm.meetingDetail.name))]),_vm._v(" ?")]),_vm._v(" "),_c('v-card-actions',[_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"grey darken-1","text":""},on:{"click":_vm.closeDialog}},[_vm._v("\n            Batal\n          ")]),_vm._v(" "),_c('v-btn',{attrs:{"color":"red darken-1","text":""},on:{"click":_vm.deleteMeetingLesson}},[_vm._v("\n            Delete\n          ")])],1)],1)],1),_vm._v(" "),_c('v-dialog',{attrs:{"persistent":"","max-width":"500"},model:{value:(_vm.createQuizDialog),callback:function ($$v) {_vm.createQuizDialog=$$v},expression:"createQuizDialog"}},[_c('v-card',[_c('v-toolbar',{attrs:{"color":"primary","dark":""}},[_c('v-card-title',{staticClass:"headline",staticStyle:{"font-weight":"bold"}},[_vm._v("\n            Create Quiz\n          ")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"white","icon":""},on:{"click":_vm.closeDialog}},[_c('v-icon',[_vm._v("mdi-close-thick")])],1)],1),_vm._v(" "),(_vm.isLoading == true)?_c('v-progress-linear',{attrs:{"indeterminate":"","color":"cyan"}}):_vm._e(),_vm._v(" "),_c('validation-observer',{ref:"observer",scopedSlots:_vm._u([{key:"default",fn:function(ref){
                var invalid = ref.invalid;
return [_c('form',{on:{"submit":function($event){$event.preventDefault();return _vm.createMeetingQuiz($event)}}},[_c('v-card-text',[_c('v-col',{attrs:{"cols":"12"}},[_c('validation-provider',{attrs:{"name":"Meeting Name","rules":"required|min:2|max:100"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                var errors = ref.errors;
return [_c('v-text-field',{attrs:{"counter":100,"error-messages":errors,"label":"Quiz Name","required":"","outlined":"","dense":""},model:{value:(_vm.quizPayload.name),callback:function ($$v) {_vm.$set(_vm.quizPayload, "name", $$v)},expression:"quizPayload.name"}})]}}],null,true)})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12"}},[_c('validation-provider',{attrs:{"name":"Quiz Duration","rules":"required|numeric|min:1|max:3|min_value:1"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                var errors = ref.errors;
return [_c('v-text-field',{attrs:{"label":"Quiz Duration","counter":3,"error-messages":errors,"outlined":"","dense":"","placeholder":"Dalam Menit, Contoh : 60"},model:{value:(_vm.quizPayload.duration),callback:function ($$v) {_vm.$set(_vm.quizPayload, "duration", $$v)},expression:"quizPayload.duration"}})]}}],null,true)})],1)],1),_vm._v(" "),_c('v-card-actions',{staticClass:"py-4 pb-4",staticStyle:{"background-color":"#e0e0e0"}},[_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"red darken-1","text":""},on:{"click":_vm.closeDialog}},[_vm._v("\n                CANCEL\n              ")]),_vm._v(" "),_c('v-btn',{staticClass:"py-4 pb-4",attrs:{"disabled":invalid,"color":"primary"},on:{"click":_vm.createMeetingQuiz}},[_vm._v("\n                Create\n              ")])],1)],1)]}}])})],1)],1),_vm._v(" "),_c('div',{staticClass:"text-center"},[_c('v-dialog',{attrs:{"persistent":"","width":"300"},model:{value:(_vm.isLoading),callback:function ($$v) {_vm.isLoading=$$v},expression:"isLoading"}},[_c('v-card',{attrs:{"color":"primary","dark":""}},[_c('v-card-text',[_vm._v("\n        Please Wait...\n        "),_c('v-progress-linear',{staticClass:"mb-0",attrs:{"indeterminate":"","color":"white"}})],1)],1)],1)],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/teacher/classes/class/_id/meeting/_meetingid/index.vue?vue&type=template&id=2aaa08bb&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/teacher/classes/class/_id/meeting/_meetingid/index.vue?vue&type=script&lang=js&
//
//
//
//
...
Object(vee_validate["extend"])("min_value", { ...rules["d" /* min_value */],
...
/* harmony default export */ var _meetingidvue_type_script_lang_js_ = ({
  head() {
    return {
  ...
  async asyncData({
    ...
    await Promise.all([store.dispatch("teacher/getMeetingDetailData", params), store.dispatch("teacher/getClassDetailData", params.id)]);
    return;
  },
  ...
  methods: {
    ...
    openEditLessonDialog(item) {
      ...
      if (item.youtube != null) {
        const id = external_get_video_id_default()(item.youtube);
    ...
    setYoutube(link) {
      const id = external_get_video_id_default()(link);
      this.ytvid = "https://www.youtube.com/embed/" + id.id;
    },

    ...Object(external_vuex_["mapActions"])("teacher", ["getMeetingDetailData", "editMeetingDetail", "deleteClassMeeting", "createLesson", "editLesson", "deleteLesson", "createQuiz"]),
    ...
    editClassMeeting() {
      this.isLoading = true;
      this.editMeetingDetail(this.meetingPayload).then(response => {
        this.closeDialog();
    ...
    deleteMeeting() {
      this.$swal({
        ...
        if (result.isConfirmed) {
          this.deleteClassMeeting(this.deleteMeetingPayload).then(response => {
            this.closeDialog();
            this.$swal({
              type: "success",
              icon: "success",
            ...
            this.snackbar = true;
            this.$router.push("/teacher/classes/class/" + this.$store.state.teacher.classDetail.id);
          }).catch(error => {
            this.closeDialog();
            this.text = error;
            this.snackbar = true;
    ...
    createMeetingLesson() {
      this.isLoading = true;
      this.createLesson(this.lessonPayload).then(response => {
    ...
    editMeetingLesson() {
      this.isLoading = true;
      this.editLesson(this.selectedLesson).then(response => {
        this.selectedLesson.id = null, this.selectedLesson.name = null, this.selectedLesson.link = null, this.selectedLesson.youtube = null, this.selectedLesson.oldName = null, this.closeDialog();
        this.isLoading = false;
    ...
    deleteMeetingLesson() {
      this.isLoading = true;
      this.deleteLesson(this.selectedLesson).then(response => {
        this.selectedLesson.id = null, this.selectedLesson.name = null, this.selectedLesson.link = null, this.selectedLesson.youtube = null, this.selectedLesson.oldName = null, this.closeDialog();
        this.isLoading = false;
    ...
    createMeetingQuiz() {
      this.isLoading = true;
      this.createQuiz(this.quizPayload).then(response => {
        this.closeDialog();
        this.isLoading = false;
        this.text = "Quiz Berhasil Dibuat";
        this.snackbar = true;
        this.$router.push("/teacher/classes/class/" + this.$store.state.teacher.classDetail.id + "/meeting/" + this.$store.state.teacher.meetingDetail.id + "/quiz/" + response.data.id);
      }).catch(error => {
        this.isLoading = false;
        this.text = error;
        this.snackbar = true;
...
// CONCATENATED MODULE: ./pages/teacher/classes/class/_id/meeting/_meetingid/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var meeting_meetingidvue_type_script_lang_js_ = (_meetingidvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./pages/teacher/classes/class/_id/meeting/_meetingid/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  meeting_meetingidvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var _meetingid = __webpack_exports__["default"] = (component.exports);
