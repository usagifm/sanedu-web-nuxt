...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/student/classes/taro dulu.vue?vue&type=template&id=3ddca663&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-app',[_c('v-alert',{attrs:{"color":"primary","dark":"","icon":"mdi-rocket","border":"left"}},[_vm._v("\n    Jika kelas belum ada, silahkan tambah kelas dengan memasukan kode kelas\n    yang anda miliki.\n  ")]),_vm._v(" "),_c('v-container',{attrs:{"fluid":""}},[_c('v-sheet',{attrs:{"color":"white","elevation":"1"}},[(_vm.isLoaded == false)?_c('v-progress-linear',{attrs:{"indeterminate":"","color":"blue lighten-1"}}):_vm._e(),_vm._v(" "),_c('v-dialog',{attrs:{"persistent":"","max-width":"290"},scopedSlots:_vm._u([{key:"activator",fn:function(ref){
var on = ref.on;
return [_c('v-col',{staticClass:"text-right"},[_c('v-btn',_vm._g({staticClass:"my-4",attrs:{"color":"primary","dark":""}},on),[_vm._v("\n              + Add Class\n            ")])],1)]}}]),model:{value:(_vm.dialog),callback:function ($$v) {_vm.dialog=$$v},expression:"dialog"}},[_vm._v(" "),_c('v-card',[(_vm.isLoading == true)?_c('v-progress-linear',{attrs:{"indeterminate":"","color":"cyan"}}):_vm._e(),_vm._v(" "),_c('v-card-title',{staticClass:"headline"},[_vm._v(" Join More Class ")]),_vm._v(" "),_c('v-card-text',[_c('v-col',{attrs:{"cols":"12"}},[_c('v-text-field',{attrs:{"label":"Enter Class Code","required":""},model:{value:(_vm.data.class_code),callback:function ($$v) {_vm.$set(_vm.data, "class_code", $$v)},expression:"data.class_code"}})],1)],1),_vm._v(" "),_c('v-card-actions',[_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"red darken-1","text":""},on:{"click":function($event){_vm.dialog = false}}},[_vm._v("\n              CANCEL\n            ")]),_vm._v(" "),_c('v-btn',{attrs:{"color":"green darken-1","text":""},on:{"click":_vm.submit}},[_vm._v(" JOIN ")])],1)],1)],1),_vm._v(" "),(_vm.isLoaded == false)?_c('v-row',[_c('v-col',{attrs:{"lg":"4","md":"6","xm":"12","sm":"6"}},[_c('v-skeleton-loader',{attrs:{"type":"card-avatar, article, actions"}})],1),_vm._v(" "),_c('v-col',{attrs:{"lg":"4","md":"6","xm":"12","sm":"6"}},[_c('v-skeleton-loader',{attrs:{"type":"card-avatar, article, actions"}})],1),_vm._v(" "),_c('v-col',{attrs:{"lg":"4","md":"6","xm":"12","sm":"6"}},[_c('v-skeleton-loader',{attrs:{"type":"card-avatar, article, actions"}})],1),_vm._v(" "),_c('v-col',{attrs:{"lg":"4","md":"6","xm":"12","sm":"6"}},[_c('v-skeleton-loader',{attrs:{"type":"card-avatar, article, actions"}})],1),_vm._v(" "),_c('v-col',{attrs:{"lg":"4","md":"6","xm":"12","sm":"6"}},[_c('v-skeleton-loader',{attrs:{"type":"card-avatar, article, actions"}})],1),_vm._v(" "),_c('v-col',{attrs:{"lg":"4","md":"6","xm":"12","sm":"6"}},[_c('v-skeleton-loader',{attrs:{"type":"card-avatar, article, actions"}})],1)],1):_vm._e(),_vm._v(" "),(_vm.isLoaded == true)?_c('v-row',_vm._l((_vm.classes),function(item){return _c('v-col',{key:item.id,attrs:{"md":"4"}},[_c('v-card',{staticClass:"mx-auto text-left",attrs:{"max-width":"400"}},[_c('v-img',{staticClass:"white--text align-end",attrs:{"height":"120px","src":"https://www.colorhexa.com/42a5f5.png"}},[_c('v-app-bar',{attrs:{"flat":"","color":"rgba(0, 0, 0, 0)"}},[_c('v-icon',{attrs:{"color":"white"}},[_vm._v("mdi-book")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"white","icon":""}},[_c('v-icon',[_vm._v("mdi-dots-vertical")])],1)],1),_vm._v(" "),_c('v-card-title',[_vm._v(_vm._s(item.name))])],1),_vm._v(" "),_c('v-card-subtitle',{staticClass:"pb-0 text--primary"},[_vm._v("\n                "+_vm._s(item.school)+"\n              ")]),_vm._v(" "),_c('v-card-subtitle',{staticClass:"pb-0 text--secondary"},[_vm._v("\n                Grade Level : "+_vm._s(item.grade_level)+"\n              ")]),_vm._v(" "),_c('v-card-subtitle',{staticClass:"pb-0 text--secondary"},[_vm._v("\n                Teacher : "+_vm._s(item.teacher_name)+"\n              ")]),_vm._v(" "),_c('v-col',[_c('v-divider'),_vm._v(" "),_c('v-chip',{attrs:{"link":""}},[_vm._v("Class Quota")]),_vm._v(" "),_c('v-progress-linear',{staticClass:"my-4",attrs:{"rounded":"","value":(item.student_number / item.quota) * 100}})],1),_vm._v(" "),_c('v-card-actions',[_c('v-btn',{attrs:{"color":"orange","text":""}},[_vm._v(" Detail ")]),_vm._v(" "),_c('v-btn',{staticStyle:{"text-decoration":"none"},attrs:{"color":"green","text":"","target":"_blank","href":'https://api.whatsapp.com/send?phone=+62' +
                    item.teacher_whatsapp}},[_vm._v("\n                  Contact Teacher\n                ")])],1)],1)],1)}),1):_vm._e()],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/student/classes/taro dulu.vue?vue&type=template&id=3ddca663&

// EXTERNAL MODULE: external "vuex"
var external_vuex_ = __webpack_require__(10);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/student/classes/taro dulu.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var taro_duluvue_type_script_lang_js_ = ({
  ...
  methods: { ...Object(external_vuex_["mapActions"])("class", ["getClassesData", "joinClass"]),
...
// CONCATENATED MODULE: ./pages/student/classes/taro dulu.vue?vue&type=script&lang=js&
 /* harmony default export */ var classes_taro_duluvue_type_script_lang_js_ = (taro_duluvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./pages/student/classes/taro dulu.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  classes_taro_duluvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var taro_dulu = __webpack_exports__["default"] = (component.exports);
...
installComponents_default()(component, {VAlert: VAlert["a" /* default */],VApp: VApp["a" /* default */],VAppBar: VAppBar["a" /* default */],VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCardActions: components_VCard["a" /* VCardActions */],VCardSubtitle: components_VCard["b" /* VCardSubtitle */],VCardText: components_VCard["c" /* VCardText */],VCardTitle: components_VCard["d" /* VCardTitle */],VChip: VChip["a" /* default */],VCol: VCol["a" /* default */],VContainer: VContainer["a" /* default */],VDialog: VDialog["a" /* default */],VDivider: VDivider["a" /* default */],VIcon: VIcon["a" /* default */],VImg: VImg["a" /* default */],VProgressLinear: VProgressLinear["a" /* default */],VRow: VRow["a" /* default */],VSheet: VSheet["a" /* default */],VSkeletonLoader: VSkeletonLoader["a" /* default */],VSpacer: VSpacer["a" /* default */],VTextField: VTextField["a" /* default */]})


/***/ })

};;
//# sourceMappingURL=taro dulu.js.map