...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/student/classes/class/_id/index.vue?vue&type=template&id=0fae12b7&
...
return [_c('v-btn',_vm._g(_vm._b({staticClass:"ml-4 my-4",attrs:{"rounded":"","color":"blue lighten-2","dark":""}},'v-btn',attrs,false),on),[_c('v-icon',{attrs:{"left":""}},[_vm._v("mdi-account-group")]),_vm._v("\n\n                    "+_vm._s(_vm.classDetail.student_number)+"\n                  ")],1)]}}],null,false,187270422)},[_vm._v(" "),_c('span',[_vm._v("Number Of Enrolled Students")])]),_vm._v(" "),_c('v-tooltip',{attrs:{"bottom":""},scopedSlots:_vm._u([{key:"activator",fn:function(ref){
                      var on = ref.on;
                      var attrs = ref.attrs;
return [_c('v-btn',_vm._g(_vm._b({staticClass:"ml-4 my-4",attrs:{"rounded":"","color":"blue lighten-2","dark":""}},'v-btn',attrs,false),on),[_c('v-icon',{attrs:{"left":""}},[_vm._v("mdi-account-multiple-plus")]),_vm._v("\n\n                    "+_vm._s(_vm.classDetail.quota)+"\n                  ")],1)]}}],null,false,3094327685)},[_vm._v(" "),_c('span',[_vm._v("Max Class Quota")])])],1)],1)],1)],1),_vm._v(" "),_c('v-row',{staticClass:"text-left",attrs:{"justify":"center"}},[_c('v-col',{staticClass:"hidden-sm-and-down",attrs:{"cols":"3"}},[_c('v-card',{staticStyle:{"border-radius":"3%"},attrs:{"light":"","outlined":""}},[_c('v-card-text',{staticStyle:{"font-weight":"bold"}},[_vm._v("\n              Ongoing  Meetings\n            ")]),_vm._v(" "),_vm._l((_vm.classMeetings),function(item){return _c('div',{key:'A'+item.id,attrs:{"justify":"center","align":"center"}},[(  _vm.$moment().unix() > _vm.$moment(item.date +' '+item.start_time).unix() && _vm.$moment().unix() < _vm.$moment(item.date +' '+item.finish_time).unix() )?_c('v-card-subtitle',{staticClass:"ml-4 pb-0 py-0",staticStyle:{"font-weight":"bold","color":"grey"}},[_c('nuxt-link',{staticStyle:{"text-decoration":"none","color":"grey"},attrs:{"to":{
                        name: 'student-classes-class-id-meeting-meetingid',
                        params: { id: _vm.classDetail.id, meetingid: item.id },
                      }}},[_vm._v("\n                  "+_vm._s(item.name)+" - "+_vm._s(item.date)+"\n                 ")])],1):_vm._e()],1)}),_vm._v(" "),_c('v-card-text',{staticStyle:{"font-weight":"bold"}},[_vm._v("\n              Upcoming Meetings\n            ")]),_vm._v(" "),_vm._l((_vm.classMeetings),function(item){return _c('div',{key:'B'+item.id,attrs:{"justify":"center","align":"center"}},[(_vm.$moment(item.date +' '+item.start_time).unix() > _vm.$moment().unix())?_c('v-card-subtitle',{staticClass:"ml-4 pb-0 py-0",staticStyle:{"font-weight":"bold","color":"grey"}},[_c('nuxt-link',{staticStyle:{"text-decoration":"none","color":"grey"},attrs:{"to":{
                        name: 'student-classes-class-id-meeting-meetingid',
                        params: { id: _vm.classDetail.id, meetingid: item.id },
                      }}},[_vm._v("\n                  "+_vm._s(item.name)+" - "+_vm._s(item.date)+"\n\n                 ")])],1):_vm._e()],1)}),_vm._v(" "),_c('v-card-actions',[_c('v-btn',{attrs:{"icon":""}},[_c('v-icon',[_vm._v(" mdi-calendar ")])],1)],1)],2)],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","lg":"9","md":"9","xs":"12","sm":"12"}},[(_vm.classMeetings)?_vm._l((_vm.classMeetingsSorted),function(item){return _c('v-row',{key:item.id},[_c('v-col',[_c('nuxt-link',{staticStyle:{"text-decoration":"none"},attrs:{"to":{
                        name: 'student-classes-class-id-meeting-meetingid',
                        params: { id: _vm.classDetail.id, meetingid: item.id },
                      }}},[_c('v-hover',{scopedSlots:_vm._u([{key:"default",fn:function(ref){
                      var hover = ref.hover;
return [_c('v-card',{class:{ 'on-hover': hover },attrs:{"light":"","elevation":hover ? 4 : 2}},[_c('v-card-title',{staticClass:"headline"},[_vm._v("\n                    "+_vm._s(item.name)+"  \n                  ")]),_vm._v(" "),(  _vm.$moment().unix() > _vm.$moment(item.date +' '+item.start_time).unix() && _vm.$moment().unix() < _vm.$moment(item.date +' '+item.finish_time).unix() )?_c('v-card-subtitle',{staticStyle:{"color":"#1E88E5"}},[_vm._v(" The Meeting is Ongoing ")]):_vm._e(),_vm._v(" "),(  _vm.$moment().unix() < _vm.$moment(item.date +' '+item.start_time).unix()  )?_c('v-card-subtitle',{staticStyle:{"color":"#43A047"}},[_vm._v(" The Meeting is Not Started Yet ")]):_vm._e(),_vm._v(" "),(  _vm.$moment().unix() > _vm.$moment(item.date +' '+item.finish_time).unix()  )?_c('v-card-subtitle',{staticStyle:{"color":"#E53935"}},[_vm._v(" The Meeting is Already Ended ")]):_vm._e(),_vm._v(" "),_c('v-col',[_c('v-chip',{staticClass:"my-2",staticStyle:{"font-weight":"bold"},attrs:{"color":"#385F73","text-color":"white"}},[_c('v-avatar',{attrs:{"left":""}},[_c('v-icon',[_vm._v("mdi-calendar")])],1),_vm._v(_vm._s(item.date)+" ")],1),_vm._v(" "),_c('v-chip',{staticClass:"my-2",staticStyle:{"font-weight":"bold"},attrs:{"color":"teal","text-color":"white"}},[_vm._v(_vm._s(item.start_time)+" - "+_vm._s(item.finish_time))])],1),_vm._v(" "),_c('v-card-actions',[(item.lessons == '')?_c('v-btn',{staticStyle:{"font-weight":"bold"},attrs:{"small":"","rounded":"","color":"primary","dark":"","text":""}},[_c('v-icon',{attrs:{"left":""}},[_vm._v("mdi-book-open-variant")]),_vm._v("No Lesson ")],1):_vm._e(),_vm._v(" "),(item.lessons != '')?_c('v-btn',{staticStyle:{"font-weight":"bold"},attrs:{"small":"","rounded":"","color":"primary","dark":"","text":""}},[_c('v-icon',{attrs:{"left":""}},[_vm._v("mdi-book-open-variant")]),_vm._v(_vm._s(item.lessons.length)+" Lessons  ")],1):_vm._e(),_vm._v(" "),(item.quiz)?_c('div',[_c('v-btn',{staticStyle:{"font-weight":"bold"},attrs:{"small":"","rounded":"","color":"success","dark":"","text":""}},[_c('v-icon',{attrs:{"left":""}},[_vm._v("mdi-pencil-circle")]),_vm._v("With Quiz ")],1)],1):_vm._e()],1)],1)]}}],null,true)})],1)],1)],1)}):_vm._e()],2)],1)],1):_vm._e()],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/student/classes/class/_id/index.vue?vue&type=template&id=0fae12b7&
