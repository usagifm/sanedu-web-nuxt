...
module.exports.__inject__ = function (context) {
  add("a60bb92c", content, true, context)
};
...
"use strict";
/* harmony import */ var _mixins_delayable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(44);
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".rounded-card{border-radius:50px}", ""]);
// Exports
module.exports = exports;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/student/classes/index.vue?vue&type=template&id=400d1754&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-layout',[_c('v-container',[(_vm.isLoaded == false)?_c('v-container',{attrs:{"fluid":""}},[_c('v-row',{attrs:{"jalign":"center","justify":"center"}},[_c('v-col',{attrs:{"cols":"6"}},[_c('v-progress-linear',{attrs:{"rounded":"","height":"6","indeterminate":"","color":"blue lighten-1"}})],1)],1)],1):_vm._e(),_vm._v(" "),(_vm.isLoaded == true)?_c('v-flex',{attrs:{"text-left":""}},[_c('v-alert',{staticStyle:{"font-weight":"bold"},attrs:{"color":"primary","dark":"","icon":"mdi-rocket","border":"left"}},[_vm._v("\n        Welcome to Sanclass\n      ")]),_vm._v(" "),_c('v-card',{staticClass:"mx-auto rounded-card",attrs:{"max-width":"100%"}},[_c('v-list-item',{attrs:{"three-line":""}},[_c('v-list-item-content',[_c('div',{staticClass:"overline mb-4"},[_vm._v("Student Account")]),_vm._v(" "),_c('v-list-item-title',{staticClass:"headline mb-1"},[_vm._v("\n                Enrolled Classes\n              ")]),_vm._v(" "),_c('v-list-item-subtitle',{staticClass:"my-4"},[_vm._v("Cant find any class ? Just add one !\n              ")])],1),_vm._v(" "),_c('v-list-item-avatar',{attrs:{"tile":"","size":"80","color":"white"}},[_c('img',{staticClass:"rounded-circle",attrs:{"src":_vm.$auth.$state.user.profile_image,"alt":_vm.$auth.$state.user.name}})])],1),_vm._v(" "),_c('v-card-actions',[_c('v-btn',{attrs:{"rounded":"","text":"","icon":"","color":"primary"}},[_c('v-icon',[_vm._v(" mdi-card-account-details ")])],1)],1)],1),_vm._v(" "),_c('v-row',{attrs:{"justify":"center","align":"center"}},[_c('v-col',{attrs:{"cols":"12","sm":"12","md":"12"}},[_c('v-dialog',{attrs:{"persistent":"","max-width":"290"},scopedSlots:_vm._u([{key:"activator",fn:function(ref){
var on = ref.on;
return [_c('v-col',{staticClass:"text-right"},[_c('v-btn',_vm._g({staticClass:"my-4",attrs:{"color":"primary","dark":""}},on),[_vm._v("\n                  + Add Class\n                ")])],1)]}}],null,false,1255680814),model:{value:(_vm.dialog),callback:function ($$v) {_vm.dialog=$$v},expression:"dialog"}},[_vm._v(" "),_c('v-card',[(_vm.isLoading == true)?_c('v-progress-linear',{attrs:{"indeterminate":"","color":"cyan"}}):_vm._e(),_vm._v(" "),_c('validation-observer',{ref:"observer",scopedSlots:_vm._u([{key:"default",fn:function(ref){
var invalid = ref.invalid;
return [_c('form',{on:{"submit":function($event){$event.preventDefault();return _vm.submit($event)}}},[_c('v-card-title',{staticClass:"headline"},[_vm._v("\n                    Join More Class\n                  ")]),_vm._v(" "),_c('v-card-text',[_c('v-col',{attrs:{"cols":"12"}},[_c('validation-provider',{attrs:{"name":"Class code input","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('v-text-field',{attrs:{"counter":10,"error-messages":errors,"label":"Class Code","required":""},model:{value:(_vm.data.class_code),callback:function ($$v) {_vm.$set(_vm.data, "class_code", $$v)},expression:"data.class_code"}})]}}],null,true)})],1)],1),_vm._v(" "),_c('v-card-actions',[_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"red darken-1","text":""},on:{"click":function($event){_vm.dialog = false}}},[_vm._v("\n                      CANCEL\n                    ")]),_vm._v(" "),_c('v-btn',{attrs:{"disabled":invalid,"color":"green darken-1","text":""},on:{"click":_vm.submit}},[_vm._v("\n                      JOIN\n                    ")])],1)],1)]}}],null,false,2279583544)})],1)],1),_vm._v(" "),(_vm.isLoaded == true)?_c('v-row',_vm._l((_vm.classes),function(item){return _c('v-col',{key:item.id,attrs:{"md":"4"}},[_c('v-hover',{scopedSlots:_vm._u([{key:"default",fn:function(ref){
var hover = ref.hover;
return [_c('v-card',{staticClass:"mx-auto text-left",class:{ 'on-hover': hover },attrs:{"max-width":"400","shaped":"","elevation":hover ? 4 : 2}},[_c('v-img',{staticClass:"white--text align-end",attrs:{"height":"120px","src":"https://www.colorhexa.com/42a5f5.png"}},[_c('v-app-bar',{staticClass:"py-5",attrs:{"flat":"","color":"rgba(0, 0, 0, 0)"}},[_c('v-icon',{attrs:{"color":"white"}},[_vm._v("mdi-book")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-tooltip',{attrs:{"bottom":""},scopedSlots:_vm._u([{key:"activator",fn:function(ref){
var on = ref.on;
var attrs = ref.attrs;
return [_c('v-btn',_vm._g(_vm._b({attrs:{"color":"white","icon":""},on:{"click":function($event){return _vm.openDeleteModal(item)}}},'v-btn',attrs,false),on),[_c('v-icon',[_vm._v("mdi-exit-to-app")])],1)]}}],null,true)},[_vm._v(" "),_c('span',[_vm._v("Unenroll")])])],1),_vm._v(" "),_c('v-card-title',[_vm._v(_vm._s(item.name))]),_vm._v(" "),_c('v-card-subtitle',{staticClass:"white--text"},[_vm._v("\n                      "+_vm._s(item.teacher_name)+"\n                    ")])],1),_vm._v(" "),_c('v-card-subtitle',{staticClass:"pb-0 text--primary"},[_vm._v("\n                    "+_vm._s(item.school)+"\n                  ")]),_vm._v(" "),_c('v-card-subtitle',{staticClass:"pb-0 text--secondary"},[_vm._v("\n                    Grade Level : "+_vm._s(item.grade_level)+"\n                  ")]),_vm._v(" "),_c('v-col',[_c('v-divider'),_vm._v(" "),_c('v-chip',{attrs:{"color":"primary"}},[_vm._v("Class Quota")]),_vm._v(" "),_c('v-chip',{attrs:{"color":"teal","text-color":"white"}},[_c('v-avatar',{attrs:{"left":""}},[_c('v-icon',[_vm._v("mdi-account-supervisor-circle")])],1),_vm._v("Students : "+_vm._s(item.student_number))],1),_vm._v(" "),_c('v-progress-linear',{staticClass:"my-4",attrs:{"rounded":"","value":(item.student_number / item.quota) * 100}})],1),_vm._v(" "),_c('v-card-actions',[_c('nuxt-link',{staticStyle:{"text-decoration":"none"},attrs:{"to":{
                        name: 'student-classes-class-id',
                        params: { id: item.id },
                      }}},[_c('v-btn',{attrs:{"color":"orange","text":""}},[_vm._v(" Detail ")])],1),_vm._v(" "),_c('v-btn',{staticStyle:{"text-decoration":"none"},attrs:{"color":"green","text":"","target":"_blank","href":'https://api.whatsapp.com/send?phone=+62' +
                        item.teacher_whatsapp}},[_vm._v("\n                      Contact Teacher\n                    ")])],1)],1)]}}],null,true)})],1)}),1):_vm._e(),_vm._v(" "),_c('v-dialog',{attrs:{"persistent":"","max-width":"450"},model:{value:(_vm.deleteModal),callback:function ($$v) {_vm.deleteModal=$$v},expression:"deleteModal"}},[_c('v-card',[_c('v-card-title',{staticClass:"headline"},[_vm._v("\n                Unenroll From Class\n              ")]),_vm._v(" "),_c('v-card-text',[_vm._v("Are you sure you want to unenroll from\n                "),_c('code',[_vm._v(" "+_vm._s(_vm.class_selected ? _vm.class_selected.name : ""))]),_vm._v("\n                ?")]),_vm._v(" "),_c('v-card-actions',[_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"grey darken-1","text":""},on:{"click":function($event){_vm.deleteModal = false}}},[_vm._v("\n                  Disagree\n                ")]),_vm._v(" "),_c('v-btn',{attrs:{"color":"red darken-1","text":""},on:{"click":_vm.unenrollClass}},[_vm._v("\n                  Agree\n                ")])],1)],1)],1)],1),_vm._v(" "),_c('div',{staticClass:"text-center"},[_c('v-snackbar',{attrs:{"timeout":_vm.timeout},scopedSlots:_vm._u([{key:"action",fn:function(ref){
                        var attrs = ref.attrs;
return [_c('v-btn',_vm._b({attrs:{"color":"blue","text":""},on:{"click":function($event){_vm.snackbar = false}}},'v-btn',attrs,false),[_vm._v("\n                Close\n              ")])]}}],null,false,496801612),model:{value:(_vm.snackbar),callback:function ($$v) {_vm.snackbar=$$v},expression:"snackbar"}},[_vm._v("\n            "+_vm._s(_vm.text)+"\n\n            ")])],1)],1)],1):_vm._e()],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/student/classes/index.vue?vue&type=template&id=400d1754&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/student/classes/index.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var classesvue_type_script_lang_js_ = ({
  ...
  data() {
    return {
      fields: ["name", "class_code", "teacher_name", "teacher_whatsapp", "student_number", "grade_level", "school"],
      items: [],
      data: {
        class_code: ""
      },
  ...
  methods: { ...Object(external_vuex_["mapActions"])("class", ["getClassesData", "joinClass", "unenrollFromClass"]),

    submit() {
      this.$refs.observer.validate();
      this.isLoading = true; // this.isLoaded = false;

      this.joinClass(this.data).then(response => {
        this.dialog = false;
        this.isLoading = false;
        this.text = "Kelas Berhasil Ditambahkan";
        this.snackbar = true; // this.isLoaded = true;
    ...
    unenrollClass() {
      this.unenrollFromClass(this.class_selected.id).then(response => {
...
// CONCATENATED MODULE: ./pages/student/classes/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var student_classesvue_type_script_lang_js_ = (classesvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./pages/student/classes/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  student_classesvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var classes = __webpack_exports__["default"] = (component.exports);
...
installComponents_default()(component, {VAlert: VAlert["a" /* default */],VAppBar: VAppBar["a" /* default */],VAvatar: VAvatar["a" /* default */],VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCardActions: components_VCard["a" /* VCardActions */],VCardSubtitle: components_VCard["b" /* VCardSubtitle */],VCardText: components_VCard["c" /* VCardText */],VCardTitle: components_VCard["d" /* VCardTitle */],VChip: VChip["a" /* default */],VCol: VCol["a" /* default */],VContainer: VContainer["a" /* default */],VDialog: VDialog["a" /* default */],VDivider: VDivider["a" /* default */],VFlex: VFlex["a" /* default */],VHover: VHover["a" /* default */],VIcon: VIcon["a" /* default */],VImg: VImg["a" /* default */],VLayout: VLayout["a" /* default */],VListItem: VListItem["a" /* default */],VListItemAvatar: VListItemAvatar["a" /* default */],VListItemContent: VList["a" /* VListItemContent */],VListItemSubtitle: VList["b" /* VListItemSubtitle */],VListItemTitle: VList["c" /* VListItemTitle */],VProgressLinear: VProgressLinear["a" /* default */],VRow: VRow["a" /* default */],VSnackbar: VSnackbar["a" /* default */],VSpacer: VSpacer["a" /* default */],VTextField: VTextField["a" /* default */],VTooltip: VTooltip["a" /* default */]})
