...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/student/classes/class/_id/index.vue?vue&type=template&id=add5ca7c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-layout',[_c('v-container',[(_vm.isLoaded == false)?_c('v-container',{attrs:{"fluid":""}},[_c('v-row',{attrs:{"jalign":"center","justify":"center"}},[_c('v-col',{attrs:{"cols":"6"}},[_c('v-progress-linear',{attrs:{"rounded":"","height":"6","indeterminate":"","color":"blue lighten-1"}})],1)],1)],1):_vm._e(),_vm._v(" "),(_vm.isLoaded == true)?_c('v-flex',[_c('v-alert',{staticStyle:{"text-decoration":"none","font-weight":"bold"},attrs:{"border":"top","colored-border":"","type":"info","elevation":"2"}},[_c('v-fab-transition',[_c('nuxt-link',{staticStyle:{"text-decoration":"none"},attrs:{"to":{
                      ...
                      }}},[_c('v-btn',{directives:[{name:"show",rawName:"v-show",value:(!_vm.hidden),expression:"!hidden"}],attrs:{"color":"blue darken-1","fab":"","dark":"","medium":"","fixed":"","bottom":"","left":""}},[_c('v-icon',[_vm._v("mdi-arrow-left")])],1)],1)],1),_vm._v(" "),_c('v-breadcrumbs',{staticClass:"pb-1 pt-3",attrs:{"link":"","items":_vm.breadcrumbs,"divider":"/"}})],1),_vm._v(" "),_c('v-row',{attrs:{"justify":"center","align":"center"}},[_c('v-col',{attrs:{"align":"left","cols":"12"}},[_c('v-card',{attrs:{"color":"#385F73","dark":""}},[_c('v-app-bar',{attrs:{"flat":"","color":"rgba(0, 0, 0, 0)"}},[_c('v-icon',{attrs:{"color":"white"}},[_vm._v("mdi-book")]),_vm._v(" "),_c('v-spacer')],1),_vm._v(" "),_c('v-card-title',{staticClass:"headline",staticStyle:{"font-weight":"bold"}},[_vm._v("\n              "+_vm._s(_vm.classDetail.name)+"\n            ")]),_vm._v(" "),_c('v-card-subtitle',{staticStyle:{"font-weight":"bold"}},[_vm._v(_vm._s(_vm.classDetail.teacher_name))]),_vm._v(" "),_c('v-btn',{staticClass:"ml-4 my-4",attrs:{"rounded":"","color":"primary","dark":""}},[_c('v-icon',{attrs:{"left":""}},[_vm._v("mdi-castle")]),_vm._v("\n\n              "+_vm._s(_vm.classDetail.school)+"\n            ")],1),_vm._v(" "),_c('v-btn',{staticClass:"ml-4 my-4",attrs:{"rounded":"","color":"blue lighten-2","dark":""}},[_c('v-icon',{attrs:{"left":""}},[_vm._v("mdi-star")]),_vm._v("\n\n              Grade Level : "+_vm._s(_vm.classDetail.grade_level)+"\n            ")],1),_vm._v(" "),_c('v-card-actions',[_c('v-tooltip',{attrs:{"bottom":""},scopedSlots:_vm._u([{key:"activator",fn:function(ref){
                      var on = ref.on;
                      var attrs = ref.attrs;
return [_c('v-btn',_vm._g(_vm._b({staticClass:"ml-4 my-4",attrs:{"rounded":"","color":"blue lighten-2","dark":""}},'v-btn',attrs,false),on),[_c('v-icon',{attrs:{"left":""}},[_vm._v("mdi-account-group")]),_vm._v("\n\n                    "+_vm._s(_vm.classDetail.student_number)+"\n                  ")],1)]}}],null,false,187270422)},[_vm._v(" "),_c('span',[_vm._v("Number Of Enrolled Students")])]),_vm._v(" "),_c('v-tooltip',{attrs:{"bottom":""},scopedSlots:_vm._u([{key:"activator",fn:function(ref){
                      var on = ref.on;
                      var attrs = ref.attrs;
return [_c('v-btn',_vm._g(_vm._b({staticClass:"ml-4 my-4",attrs:{"rounded":"","color":"blue lighten-2","dark":""}},'v-btn',attrs,false),on),[_c('v-icon',{attrs:{"left":""}},[_vm._v("mdi-account-multiple-plus")]),_vm._v("\n\n                    "+_vm._s(_vm.classDetail.quota)+"\n                  ")],1)]}}],null,false,3094327685)},[_vm._v(" "),_c('span',[_vm._v("Max Class Quota")])])],1)],1)],1)],1),_vm._v(" "),_c('v-row',{staticClass:"text-left",attrs:{"justify":"center"}},[_c('v-col',{staticClass:"hidden-sm-and-down",attrs:{"cols":"3"}},[_c('v-card',{staticStyle:{"border-radius":"3%"},attrs:{"light":"","outlined":""}},[_c('v-card-text',{staticStyle:{"font-weight":"bold"}},[_vm._v("\n              Ongoing  Meetings\n            ")]),_vm._v(" "),_vm._l((_vm.classMeetings),function(item){return _c('div',{key:'A'+item.id,attrs:{"justify":"center","align":"center"}},[(  _vm.$moment().unix() > _vm.$moment(item.date +' '+item.start_time).unix() && _vm.$moment().unix() < _vm.$moment(item.date +' '+item.finish_time).unix() )?_c('v-card-subtitle',{staticClass:"p-0",staticStyle:{"font-weight":"bold","color":"grey"}},[_vm._v("\n                  "+_vm._s(item.name)+" - "+_vm._s(item.date)+"\n               ")]):_vm._e()],1)}),_vm._v(" "),_c('v-card-text',{staticStyle:{"font-weight":"bold"}},[_vm._v("\n              Upcoming Meetings\n            ")]),_vm._v(" "),_vm._l((_vm.classMeetings),function(item){return _c('div',{key:'B'+item.id,attrs:{"justify":"center","align":"center"}},[(_vm.$moment(item.date +' '+item.start_time).unix() > _vm.$moment().unix())?_c('v-card-subtitle',{staticClass:"p-0",staticStyle:{"font-weight":"bold","color":"grey"}},[_vm._v("\n                  "+_vm._s(item.name)+" - "+_vm._s(item.date)+"\n\n\n               ")]):_vm._e()],1)}),_vm._v(" "),_c('v-card-actions',[_c('v-btn',{attrs:{"icon":""}},[_c('v-icon',[_vm._v(" mdi-calendar ")])],1)],1)],2)],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","lg":"9","md":"9","xs":"12","sm":"12"}},[(_vm.classMeetings)?_vm._l((_vm.classMeetings),function(item){return _c('v-row',{key:item.id},[_c('v-col',[_c('nuxt-link',{staticStyle:{"text-decoration":"none"},attrs:{"to":{
                      ...
                      var hover = ref.hover;
return [_c('v-card',{class:{ 'on-hover': hover },attrs:{"light":"","elevation":hover ? 4 : 2}},[_c('v-card-title',{staticClass:"headline"},[_vm._v("\n                    "+_vm._s(item.name)+"  \n                  ")]),_vm._v(" "),(  _vm.$moment().unix() > _vm.$moment(item.date +' '+item.start_time).unix() && _vm.$moment().unix() < _vm.$moment(item.date +' '+item.finish_time).unix() )?_c('v-card-subtitle',[_vm._v(" The Meeting is Ongoing ")]):_vm._e(),_vm._v(" "),(  _vm.$moment().unix() < _vm.$moment(item.date +' '+item.start_time).unix()  )?_c('v-card-subtitle',[_vm._v(" The Meeting is Not Started Yet ")]):_vm._e(),_vm._v(" "),(  _vm.$moment().unix() > _vm.$moment(item.date +' '+item.finish_time).unix()  )?_c('v-card-subtitle',[_vm._v(" The Meeting is Already Ended ")]):_vm._e(),_vm._v(" "),_c('v-col',[_c('v-chip',{staticStyle:{"font-weight":"bold"},attrs:{"color":"#385F73","text-color":"white"}},[_c('v-avatar',{attrs:{"left":""}},[_c('v-icon',[_vm._v("mdi-calendar")])],1),_vm._v(_vm._s(item.date)+" ")],1),_vm._v(" "),_c('v-chip',{staticStyle:{"font-weight":"bold"},attrs:{"color":"teal","text-color":"white"}},[_vm._v(_vm._s(item.start_time)+" - "+_vm._s(item.finish_time))])],1),_vm._v(" "),_c('v-card-actions',[(item.lessons == '')?_c('v-btn',{attrs:{"rounded":"","color":"primary","dark":"","text":""}},[_c('v-icon',{attrs:{"left":""}},[_vm._v("mdi-book-open-variant")]),_vm._v("No Lesson ")],1):_vm._e(),_vm._v(" "),(item.lessons != '')?_c('v-btn',{attrs:{"rounded":"","color":"primary","dark":"","text":""}},[_c('v-icon',{attrs:{"left":""}},[_vm._v("mdi-book-open-variant")]),_vm._v(_vm._s(item.lessons.length)+" Lessons  ")],1):_vm._e(),_vm._v(" "),(item.quiz)?_c('div',[_c('v-btn',{attrs:{"rounded":"","color":"success","dark":"","text":""}},[_c('v-icon',{attrs:{"left":""}},[_vm._v("mdi-pencil-circle")]),_vm._v("With Quiz ")],1)],1):_vm._e()],1)],1)]}}],null,true)})],1)],1)],1)}):_vm._e()],2)],1)],1):_vm._e()],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/student/classes/class/_id/index.vue?vue&type=template&id=add5ca7c&

// EXTERNAL MODULE: external "vuex"
var external_vuex_ = __webpack_require__(9);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/student/classes/class/_id/index.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var _idvue_type_script_lang_js_ = ({
  ...
  async asyncData({
    ...
    console.log(params);
    await Promise.all([store.dispatch("class/getClassDetailData", params.id), store.dispatch("class/getClassMeetings", params.id)]);
    return;
  },
  ...
  methods: { ...Object(external_vuex_["mapActions"])("class", ["getClassesDetailData"]),
...
// CONCATENATED MODULE: ./pages/student/classes/class/_id/index.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./pages/student/classes/class/_id/index.vue
...
installComponents_default()(component, {VAlert: VAlert["a" /* default */],VAppBar: VAppBar["a" /* default */],VAvatar: VAvatar["a" /* default */],VBreadcrumbs: VBreadcrumbs["a" /* default */],VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCardActions: components_VCard["a" /* VCardActions */],VCardSubtitle: components_VCard["b" /* VCardSubtitle */],VCardText: components_VCard["c" /* VCardText */],VCardTitle: components_VCard["d" /* VCardTitle */],VChip: VChip["a" /* default */],VCol: VCol["a" /* default */],VContainer: VContainer["a" /* default */],VFabTransition: transitions["c" /* VFabTransition */],VFlex: VFlex["a" /* default */],VHover: VHover["a" /* default */],VIcon: VIcon["a" /* default */],VLayout: VLayout["a" /* default */],VProgressLinear: VProgressLinear["a" /* default */],VRow: VRow["a" /* default */],VSpacer: VSpacer["a" /* default */],VTooltip: VTooltip["a" /* default */]})
